...
import { mock, instance, when, verify, reset, capture } from 'ts-mockito';
import { test, expect, describe, vi, afterEach, it, beforeEach } from 'vitest';
...
describe('Users UseCase', () => {
  test('Should be able create a new User', () => {
    ...
    it('should create a new user successfully', async () => {
      ...
      verify(usersRepository.create(expect.anything())).once();
      if (file?.buffer) {
