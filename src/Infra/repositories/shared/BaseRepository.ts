...
import { Children, Files, Folders, RefreshTokens, Users, } from "@prisma/client";
...
@injectable()
export class BaseRepository<T extends Users | Files | Folders | RefreshTokens | Children > implements IBaseRepository<T> {
